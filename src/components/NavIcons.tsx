    ...
    <div>
      <div className='flex items-center gap-4 xl:gap-6 relative'>
        ...
        <Image src='/cart.png' alt="" width={22} height={22} className='cursor-pointer'
         />
        <div className='absolute -top-4 -right-4 w-6 h-6 bg-chirag rounded-full text-white
        text-sm flex items-center justify-center'>{counter}</div>
        </div>
        {isCartOpen && (
          <CartModal/>
        )}
